                              ...
                              .then(async (response_six) => {
                                ...
                                try {
                                  for (let i = 0; i < email.length; ++i) {
                                    let respone = await axiosInstance.get(
                                      `parser/getFiles/${email[i].resume_fname}/`,
                                      { responseType: "blob" }
                                    );
                                    // let file = new Blob([respone.data], {type: 'application/pdf'});
                                    // file.name = email[i].resume_fname;
                                    const myBlob = new Blob([respone.data], {
                                      type: "application/pdf,.doc,.docx,application/docx",
                                    });
                                    const myFile = new File(
                                      [Object.values(email[i].finalcv)],
                                      {
                                        type: "application/pdf,.doc,.docx,application/docx",
                                      }
                                    );
                                    ...
                                    listEntry1.append(
                                      "email",
                                      email[i].resume_email
                                    );
                                    listEntry1.append(
                                      "phone_number",
                                      email[i].resume_phone
                                    );
                                    listEntry1.append(
                                      "file_name",
                                      email[i].resume_fname
                                    ...
                                    listEntry1.append(
                                      "summary",
                                      email[i].resume_summary
                                    );

                                    respone = await axiosInstance.post(
                                      URL,
                                      listEntry1,
                                      config
                                    );
            ...
            <form onSubmit={props.handleSubmit}>
              <Grid container spacing={2} padding={5}>
                <DropzoneDialog
                  ...
                  showFileNames={true}
                  acceptedFiles={[
                    "application/pdf,.doc,.docx,application/docx",
                  ]}
                  open={dropzoneOpen}
                  onClose={() => {
                    ...
                    <CardContent className={classes.content}>
                      ...
                      >
                        <Grid item>
                          ...
                          >
                            Upload Your Resumes above.{" "}
                            <p>
                              Some of your files may not be parsed if corrupt!
                            </p>
                          </Typography>
                        </Grid>
                      </Grid>
                    ...
                    <CardContent style={{ textAlign: "center" }}>
                      <div>
                        ...
                        <Input
                          ...
                          value={props.values["CV_Num_Input"]}
                        />
                        <Typography variant="body1" style={{ fontSize: 16 }}>
                          {" "}
                          {"Percentage Match: "}{" "}
                        ...
                        <Input
                          ...
                          name="Percent_Input"
                          onChange={props.handleChange}
                          value={props.values["Percent_Input"]}
                        />
                        <Box
                          sx={{
                            display: "flex",
                    ...
                    <CardContent className={classes.content}>
                      ...
                      >
                        <Grid item>
                          ...
                          >
                            Upload your Job Description above.{" "}
                            <p>It should be just one file!</p>
                          </Typography>
                        </Grid>
                      </Grid>
                    </CardContent>
