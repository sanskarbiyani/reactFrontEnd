...
export function DisplaylogEnties({onChange}){
  ...
  const [open, setOpen] = React.useState(false);
    ...
    useEffect(() => {
      ...
      axiosInstance
        .get(`logentries/${listname['list']}`).then((res)=>{
            ...
            setAppState({loading: false,listHistory:[ress.data],  data : [...allData] });      
            })
            .catch(e=>{
            console.log(e)
        })
    ...
    return (
        <div className="App">
            ...
            <PostLoadingComponent isLoading={appState.loading} cols={appState.cols} data={appState.data} id={appState.id} listHistory ={appState.listHistory}/>
        </div>
    );
}