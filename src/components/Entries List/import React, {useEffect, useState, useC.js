                        ...
                        >
                          ...
                          <ListItemSecondaryAction>
                            <IconButton
                              ...
                              onClick={() => {
                                axiosInstance
                                  .delete(`deletemodel/ModelSchema/${lis[0]}/`)
                                  .then((response) => {
                                    // alert(response.data);
  ...
  const allLists = () => {
    ...
    return (
      <div style={{ width: "100%" }}>
        ...
        <Paper
          style={{ height: 470, overflow: "auto", padding: 30 }}
          elevation={0}
        >
          <Grid container>
            {selectedList.map((lis, index) => {
    ...
    <div className="App">
      <Container maxWidth={false}>
        <div style={{ marginTop: 20, marginBottom: 10 }}>
          <Typography style={{ marginLeft: 15, marginBottom: 10 }} variant="h5">
            MyLists
          </Typography>
                              ...
                              action={
                                <div>
                                  ...
                                  <Menu
                                    ...
                                    keepMounted
                                    open={
                                      anchorEl1 && Boolean(anchorEl1[index])
                                    }
                                    ...
                                    <div>
                                      <MenuItem
                                        ...
                                        onClick={() => {
                                          axiosInstance
                                            .delete(
                                              `deletemodel/ModelSchema/${rec[0]}/`
                                            )
                                            .then((res) => {
                                              enqueueSnackbar(
                                                `${rec[0]} Delete Successfully`,
                                                {
                                                  variant: "error",
                                                }
                                              );
