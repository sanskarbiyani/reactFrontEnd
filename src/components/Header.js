    ...
    if (!CurrUserName) {
      if (user) {
        ...
        axiosInstance
          ...
          .then((response) => {
            localStorage.setItem("currUserName", response.data.message);
          ...
          <Grid container spacing={1} alignItems="flex-end">
            ...
            {(props.isList && (
              <>
                    ...
                    {badgeMenu.map((item, i) => {
                      return (
                        <PopOverMenu
                          ...
                          icon={
                            <Icon
                              component={MuiIcons[listname["icon"]]}
                              style={{ fontSize: 40, color: listname["color"] }}
                            ></Icon>
                          }
                          where={"header"}
                          menu={item.menu}
                ...
                <Grid item>
                  <Tooltip
                    title={listname["modelname"]}
                    placement="right-start"
                    arrow
                  >
                    <TextField
                      defaultValue={listname["modelname"]}
                      onBlur={(e) => {
                        // const listdetail =  JSON.parse(localStorage.getItem('listname'))
                        if (e.target.value.length !== 0) {
                          axiosInstance
                            .put(`editModelname/${listname["modelname"]}/`, {
                            ...
                            .then((res) => {
                              ...
                              enqueueSnackbar(
                                `${e.target.value} Update Successfully`,
                                {
                                  variant: "success",
                                }
                              );
          ...
          <Grid container>
            ...
            >
              ...
              <Tab
                ...
                className={classes.link}
                component={NavLink}
                to={`/create-new-list/self/${getUser()}`}
              />
              <Tab
                textColor="inherit"
                label="Group"
